        ...
        <div className='container'>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/TraditionalClimbing" className="link-item no-underline">
                            ...
                            Traditional climbing, also known as "trad climbing," is one of the popular climbing styles within the climbing community ...
                                <Link to="/TraditionalClimbing" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/SportClimbing" className="link-item no-underline">
                            ...
                            Sport climbing is a popular climbing discipline, renowned for its athletic nature and the demands it places on physical strength and technique...
                                <Link to="/SportClimbing" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/Bouldering" className="link-item no-underline">
                            ...
                            Bouldering is a popular climbing discipline performed at low heights without the use of ropes or protective gear...
                                <Link to="/Bouldering" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/IceClimbing" className="link-item no-underline">
                            ...
                            Ice climbing, also known as ice climbing, is a specialized form of climbing where climbers must navigate icy surfaces, such as frozen waterfalls...
                                <Link to="/IceClimbing" className="btn custom-btn btn-info "><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/AlpineClimbing" className="link-item no-underline">
                            ...
                            Alpine climbing, also known as high-altitude climbing, is a form of climbing that combines elements of rock climbing, ice climbing, and trekking on snow.
                                <Link to="/AlpineClimbing" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/ViaFerrata" className="link-item no-underline">
                            ...
                            Via Ferrata, an Italian term meaning "iron road," is a unique form of climbing where climbers use a system of steel cables...
                                <Link to="/ViaFerrata" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/FreeSoloClimbing" className="link-item no-underline">
                            ...
                            Free solo climbing, also known as free soloing, is the most dangerous and adventurous form of climbing, where climbers...
                                <Link to="/FreeSoloClimbing" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className='types-1'>
                            <Link to="/MixedClimbing" className="link-item no-underline">
                            ...
                            Mixed climbing is a form of climbing that combines rock climbing and ice climbing, typically occurring on mixed terrain where climbers...
                                <Link to="/MixedClimbing" className="btn custom-btn btn-info"><span className="more-text">More</span></Link>
                            </p>
                        </div>
                    </div>
