        ...
        <div className="container   homelink88">
            ...
            <div className="mb-4">
                ...
                <figure className="text-center mt-4 mb-4 ">
                    <img src="/images/home-link99.jpg" className="img-fluid rounded homelink66" alt="img-link99" />
            ...
            <div className="mb-4">
                ...
                <figure className="text-center mt-4 mb-4">
                    <img src="/images/home-link66.jpg" className="img-fluid rounded  homelink66" alt="img-link66" />
                    <figcaption className="fs-6 mt-2">Illustrative Image</figcaption>
                </figure>
            </div>
            ...
            <div className="mb-4">
                ...
                <figure className="text-center mt-4 mb-4">
                    <img src="/images/hazards.jpg" className="img-fluid rounded   homelink66" alt="img-haz1" />
                    <figcaption className="fs-6 mt-2">Illustrative Image</figcaption>
                </figure>
                <div className="mb-3">
            ...
            <div className="mb-4">
                ...
                <figure className="text-center mt-4 mb-4">
                    <img src="/images/hazards5.jpg" className="img-fluid rounded  homelink66" alt="img-haz6" />
                    <figcaption className="fs-6 mt-2">Illustrative Image</figcaption>
                </figure>
                <div>
